...
const LeftBar = () => {
    return (
        <div className=' flex flex-col items-center px-8 gap-8 pt-8 border h-screen'>
            <img className=' font-extrabold  text-lg p-2' src={logo} />
            <div className=''>
...
const MiniProfile = () => {
    return (
        <div className=' bg-background w-full rounded-xl  p-6  text-text-primary flex flex-col gap-4 text-sm'>
            ...
            <button className='  border  border-accent  text-accent rounded-lg p-1 py-2 font-semibold'>
            ...
            <button className='bg-accent rounded-lg p-1 py-2 text-white font-semibold'> logout</button>
        </div>
    )
}
