...
const MiniProfile = () => {
    ...
    return (
        <Card className='flex flex-col gap-4 p-4 text-sm bg-backgroundBody'>
            ...
            <button className='  border-none   hover:bg-opacity-25 duration-300 text-accent bg-accent bg-opacity-10 rounded-full p-1 py-2 font-semibold'>
                <div className=' flex gap-2 justify-center items-center'>
                    Share
                    <MdContentCopy size={"16px"} />
                </div>
            </button>
            <button className='bg-accent hover:bg-sky-400 duration-300 rounded-full p-1 py-2 text-white font-semibold' onClick={handleLogout}> logout</button>
