        ...
        <div className=' bg-background w-full rounded-xl px-6 pt-6 pb-4  text-text-primary flex flex-col gap-4 text-sm'>
            <div className=' flex gap-4 w-full'>
                ...
                <div className='w-full flex flex-col items-center'>
                    <div className='grid grid-cols-[auto_100px] w-full gap-4'>
                        <div>
                            <input type='text' placeholder='Whats Happening ?' className='flex justify-center items-center gap-2 px-4 py-2 rounded-xl w-full focus:outline-none  bg-background-dark text-text-primary' />
